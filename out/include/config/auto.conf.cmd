...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/media/macka/Main/toolchain/aarch64/bin/aarch64-linux-gnu- --gcc-toolchain=/media/macka/Main/toolchain/aarch64 -no-integrated-as  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
